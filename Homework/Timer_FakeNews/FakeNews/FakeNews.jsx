...
function FakeNews() {
    ...
    const handleButtonClick=() => {
        if (colorRef.current && titledRef.current && bodyRef.current){
            colorRef.current.style.backgroundColor='orange'
            titledRef.current.textContent = '[속보] 밥준서, 상록원이 아닌 기숙사 식당에서 발견돼'
...
return (
    <>
        ...
        <div ref={colorRef}>
            <h2 ref = {titledRef}>[속보] 밥준서, 상록원에서 숨 쉰 채로 발견돼</h2>
